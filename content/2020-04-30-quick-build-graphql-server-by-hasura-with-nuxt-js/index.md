...
まあ、本当に書いてある通りで、**既存や新規のデータベースに対して GraphQL API サーバーを爆速で構築できる**ソフトウェアです。  
後々に Hasura が要らないってなった場合にも、別に GraphQL サーバーを立ててあげれば大抵は解決するので、サービスへの依存度も比較的低くなりやすく使いやすいサービスかなと思います。
